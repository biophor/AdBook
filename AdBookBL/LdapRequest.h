...
class ADBOOKBL_API LdapRequest
{
public:
    LdapRequest();
    ~LdapRequest();
    ...
    void AddRule(const Attributes::AttrId attrId, const MathingRule rule, const std::wstring & value);
    void AddRule(const std::wstring & attrName, const MathingRule rule, const std::wstring & value);
