...
namespace WpfAdBook.Services
{
    ...
    {
        // must return true if user wants to exit
        bool RequestConfirmationOnAppExit();

        bool IsSettingsWindowVisible();
        void DisplaySettingsWindow();
        void CloseSettingsWindow();

        bool IsPersonEditorVisible();
        void DisplayEditPersonWindow();
        void SaveEditPersonWindowState();
        void RestoreEditPersonWindowState();
