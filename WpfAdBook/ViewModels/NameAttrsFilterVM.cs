...
{
    [Serializable]
    public class NameAttrsFilterVM : FilterVM, IEquatable<NameAttrsFilterVM>
    {
        public override string DisplayName
        {
            get {
                return Properties.Resources.Filter_Names;
            }
        }
        ...
        public bool Equals(NameAttrsFilterVM other)
        {
        ...
        {
            return Equals(obj as NameAttrsFilterVM);
        }
